    ...
    if(validaCampos()){
        ...
        if(txt_senha1.value == txt_senha2.value){
            ...
            if(resp.Status == true){
                ...
                resultado.innerHTML = "<span style=' color: green'>Usuário cadastrado!</span>";
            }       
            else{
                //alert("Usuário não cadastrado!");
                resultado.innerHTML = "<span style=' color: red'>Login já exite!</span>";
            }     
        }
        else{
            //alert("Senhas diferentes!");
            resultado.innerHTML = "<span style=' color: red'>Senhas diferentes!</span>";
        }
    }
})
